...
limpio, `npm run build` en verde, **149 pruebas de Playwright en verde**.
...
- `admin@indepsoft.com` — administrador de plataforma. Aterriza en `/admin`,
  activa las suscripciones de los equipos nuevos, y puede entrar en CUALQUIER
  equipo desde el conmutador para verlo todo — de sólo lectura, con una cinta
  que lo dice.
...
- `tests/visual/screenshots.spec.ts`: **149 pruebas**. Muchas están
